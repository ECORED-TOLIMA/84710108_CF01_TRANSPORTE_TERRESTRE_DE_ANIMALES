  ...
  .container.tarjeta.tarjeta--blanca.p-4.p-md-5.mb-5
    ...
    .row.justify-content-center.align-items-center.mb-5
      .col-lg-9.order-lg-1.order-2.mb-lg-0
        p(data-aos="fade-right") La magnitud de carga es el resultado de una doble verificación que combina la seguridad vial (peso legal) y el bienestar animal (densidad operativa). La normativa colombiana exige que el transportador aplique técnicas de cálculo para asegurar que se cumplan ambos límites de manera simultánea.
        p(data-aos="fade-right") Por su parte, la Resolución 20223040006915 establece que la densidad de carga debe determinarse a partir de fórmulas de cálculo o de las tablas anexas (Apéndices).
        p.mb-4(data-aos="fade-right") A continuación, se detallan las técnicas de cálculo de la magnitud de carga:
    ...
    p.mb-4(data-aos="fade-right") Por su parte, aunque el manual se basa principalmente en la prevención del sufrimiento (Ley 1774), el Plan de Capacitación en Bienestar Animal integra un enfoque más amplio, como el de los Cinco Dominios, que evalúa las condiciones del animal, así:
        ...
        .row.justify-content-center.align-items-center
          .col-lg-12
            ...
            .row.justify-content-center.align-items-center.mb-4 
              .col-lg-10
                .tabla-a.color-acento-contenido.table-wrapper
                  table.tabla-responsive(style="background-color: white;")
                    thead
                      tr
    ...
    .row.justify-content-center.align-items-center.mb-5
      .col-lg-9
        p(data-aos="fade-right") La limpieza y el aseo de las unidades de transporte son un pilar fundamental de los protocolos de bioseguridad y las condiciones sanitarias exigidas por la normativa. Las técnicas se centran en la eliminación de materia orgánica y la desinfección para prevenir la propagación de enfermedades.
    ...
    p(data-aos="fade-right") La vigilancia del bienestar animal y las condiciones sanitarias durante el transporte terrestre es una carga de autoridades específicas que tienen la facultad de inspeccionar, controlar y sancionar el incumplimiento de la normativa.
    p.mb-4(data-aos="fade-right") Por lo anterior, se invita a analizar la siguiente imagen:
    ...
    p.mb-4(data-aos="fade-right") El temario se centra en las disposiciones del Manual de Procedimientos para el Transporte, Manejo y Movilización de Animales en Pie, incluyendo:
